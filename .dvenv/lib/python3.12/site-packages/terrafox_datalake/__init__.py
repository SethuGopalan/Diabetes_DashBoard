...
def disconnect():
    """Clear cached credentials and environment variables."""
    global _user, _password, _endpoint
    ...
    os.environ.pop("MINIO_USER", None)
    os.environ.pop("MINIO_PASSWORD", None)

    print("🔌 Terrafox Data Lake Disconnected!")